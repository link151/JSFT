...
.controller('homeCtrl',['$scope','$rootScope','$http','$location','$cookies','$cookieStore',
...
//		alert($rootScope.dept);
	...
	/*var refunddate = getrefundDate();
	$http.get('selectDraftNotice/' + refunddate + '.do').success(function(data){
//		alert("success");
